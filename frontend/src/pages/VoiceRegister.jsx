...
const VoiceRegister = () => {
  ...
  useEffect(() => {
    ...
    if ("webkitSpeechRecognition" in window) {
      ...
      speak("Welcome to Voice Registration. Please say your name.");
    } else {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    speak("Processing your registration. Please wait.");
    ...
    try {
      ...
      const nameRegistrationResponse = await axios.post(
        `http://localhost:5000/users/registerwithName`,
        { name },
      ...
      const voiceRegistrationResponse = await axios.post(
        `http://127.0.0.1:8000/register_speaker/${encodeURIComponent(name)}`,
        formData,
        {
          headers: {
      ...
      if (voiceRegistrationResponse.data) {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-6">
      ...
      <h1 className="text-3xl font-bold mb-8">Voice Register</h1>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 text-xl">
          ...
          <Link to="/voiceLogin" className="font-semibold text-blue-400">
            Login
          </Link>
        </div>
      </div>
